                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Los mineros de Cananea, Sonora, demandan iguales salarios para extranjeros y mexicanos. 

Se dio por la explotación y la miseria que vivían los obreros , la injusticia y la desigualdad entre 
los trabajadores mexicanos y extranjeros donde "El desarrollo alcanzado en México no beneficiaba en nada al pueblo ni a los trabajadores".''', style: TextStyle(color: Colors.white))
                        ,Image.asset('images/Cronologia/cananea.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Se lleva a cabo la rebelión obrera de las compañías textiles de Río
Blanco, Veracruz. 
''', style: TextStyle(color: Colors.white))
                        ,Image.asset('images/Cronologia/rioblanco.jpg')
                        ],        
                      ),
                    ),
                  ),
...
''', style: TextStyle(color: Colors.white))
                          ,Image.asset('images/Cronologia/entrevistadiaz.jpg')
                        ],        
                      ),
                    ),
                  ),
                ...
                child: Container(
                  width: (MediaQuery.of(context).size.width) * 0.6,
                    child: Card(
                      ...
                      , style: TextStyle(color: Colors.white))
                      ,Image.asset('images/Cronologia/libroFIM.jpg')
                          ],        
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Elecciones entre Madero y Diaz.
...
''', style: TextStyle(color: Colors.white))
                          ,Image.asset('images/Cronologia/plansl.jpg')],        
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/revmex.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text(''' Francisco Madero convence a Francisco “Pancho” Villa y Pascual Orozco a unirse a la revolución.
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text(''' Emiliano Zapata lidera un levantamiento de campesinos para luchar por los derechos sobre la tierra y el agua. 

Revueltas armadas comenzaron simultáneamente en otras partes de Mexico.
''', style: TextStyle(color: Colors.white))
,Image.asset('images/Cronologia/zapatagente.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text(''' Francisco Villa y Pascual Orozco ataca y toma Ciudad Juárez; desde allí Madero envió un telegrama exigiendo de nuevo la renuncia de los dos líderes del país. 
''', style: TextStyle(color: Colors.white))
,Image.asset('images/Cronologia/tomacdj.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''  Se celebraron los Tratados de Ciudad Juárez, en donde se aceptaba la renuncia de Porfirio Díaz.''', style: TextStyle(color: Colors.white))
                        ],        
                      ),
                    ),
                  ),
...
Frencisco León de la Barra sutituye a Porfirio Diaz como presidente interino.''', style: TextStyle(color: Colors.white))
                        ,Image.asset('images/Cronologia/fcoleondlb.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('  Porfirio Diaz Exilia a Francia.', style: TextStyle(color: Colors.white))
                          ,Image.asset('images/Cronologia/exiliopd.jpg')    
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/fimpresi.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''A sólo unos días de asumir el poder Francisco I. Madero, estalló en Morelos un levantamiento promovido por Emiliano Zapata, ya que al llegar Francisco I. Madero a la Presidencia.

Zapata le exigió que expidiera una ley Agraria; a cambio Madero, le pidió entregar las armas. 

Zapata no acepta y da a conocer el Plan de Ayala, a través del cual se exigía entre otras cosas, la renuncia de Madero. Su lema era “Tierra y Libertad”. .''', style: TextStyle(color: Colors.white))
                        ,Image.asset('images/Cronologia/tyl.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Pascual Orozco encabeza una rebelión en Chihuahua, después de perder las elecciones para gobernador. 
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Huerta encabeza un golpe contra Madero, mejor conocido como la decena trágica, Madero renuncia a la precidencia para ser arrestado y encarcelado.''', style: TextStyle(color: Colors.white))
                          ,Image.asset('images/Conceptos/golpedestado.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Pedro Lascuráin toma el poder como presidente interino, cuya gestión se prolongó de las 10:34 a las
11:00 de la mañana de aquel día, es la gestion mas corta en la hitoria de México (45 minutos).
	
Victoriano Huerta es presidente.''', style: TextStyle(color: Colors.white))
                      ,Image.asset('images/Cronologia/plasc.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                         ...
                         ,Image.asset('images/Cronologia/fimmuerte.jpg')  
                        ],        
                      ),
                    ),
                  ),
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        ,Image.asset('images/Cronologia/tiosam.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/fcocarba.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/carranpresi.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Text('''Desaparecido el régimen huertista, los caudillos revolucionarios tenian diferencias entre sí:
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          const Text( '10 de Octubre al 9 de Noviembre 1914',style: TextStyle(color: Colors.white)),
                          const Text('''Se convoca la convencion de Aguascalientes donde asistió Álvaro Obregón en representación de Venustiano Carranza, Emiliano Zapata, y Francisco Villa. 

Los convencionistas acordaron la renuncia de Carranza, Villa yZapata a los mandos que ejercían y se nombra Presidente a Eulalio Gutiérrez.''', style: TextStyle(color: Colors.white))
                        ,Image.asset('images/Cronologia/convags.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/eulaguti.jpg')
                        ],        
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ,Image.asset('images/Cronologia/pvillacol.jpg')
                        ],        
                      ),
                    ),
                  ),
...
•	El Artículo 123 estableció un régimen de protección a la clase trabajadora''', style: TextStyle(color: Colors.white))
                          ,Image.asset('images/Cronologia/1917.jpg')
                          ],        
                        ),
                      ),
                    ),
